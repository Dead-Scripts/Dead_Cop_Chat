...
RegisterNetEvent('DeadCopChat:Server:GetUserData')
AddEventHandler('DeadCopChat:Server:GetUserData', function()
	local src = source
	...
	if isCop[src] == nil then
		if identifierDiscord then
			...
			if not (roleIDs == false) then
				...
				print("[DeadCopChat] " .. GetPlayerName(src) .. " has not gotten their access to /leoChat cause roleIDs == false")
			end
		else
			print("[DeadCopChat] " .. GetPlayerName(src) .. " has not gotten their access to /leoChat cause their discord was not detected...")
		end
	end
end)
